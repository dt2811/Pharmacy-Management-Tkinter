...
class Database:
    def __init__(self, master, *args, **kwargs):
        ...
        #self.i = Label(master, text="ID Has Reached: " + str(id), font=('arial 18 bold'))
        ...
        self.name_e.place(x=450, y=70)

        self.stock_e = Entry(master, width=25, font=('arial 18'))
        self.stock_e.place(x=450, y=120)

        self.cp_e = Entry(master, width=25, font=('arial 18'))
        self.cp_e.place(x=450, y=170)

        self.sp_e = Entry(master, width=25, font=('arial 18'))
        self.sp_e.place(x=450, y=220)

        self.vendor_e = Entry(master, width=25, font=('arial 18'))
        self.vendor_e.place(x=450, y=270)

        self.vendor_phone_e = Entry(master, width=25, font=('arial 18'))
        self.vendor_phone_e.place(x=450, y=320)

        self.id_e = Entry(master, width=25, font=('arial 18'))
        self.id_e.place(x=450, y=370) 

        # button to add to the database
        self.btn_add = Button(master, text="Add Records", width=25, height=2, bg='lightgreen', fg='white', command=self.get_items)
        self.btn_add.place(x=300, y=420)
        ...
        self.btn_clear.place(x=600, y=420)

        # text box for the logs
        self.tBox = Text(master, width=60, height=20)
        self.tBox.place(x=800, y=70) 
        self.tBox.insert(END, "Number of products in store has reached ID: " + str(id))
