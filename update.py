...
class Database:
    def __init__(self, master, *args, **kwargs):
        ...
        self.stock_l = Label(master, text="Stock:", font=('arial 18 bold'))
        ...
        self.name_e = Entry(master, width=25, font=('arial 18'))
        self.name_e.place(x=450, y=120)

        self.stock_e = Entry(master, width=25, font=('arial 18'))
        self.stock_e.place(x=450, y=170)

        self.cp_e = Entry(master, width=25, font=('arial 18'))
        self.cp_e.place(x=450, y=220)

        self.sp_e = Entry(master, width=25, font=('arial 18'))
        self.sp_e.place(x=450, y=270)

        self.totalcp_e = Entry(master, width=25, font=('arial 18'))
        self.totalcp_e.place(x=450, y=320)

        self.totalsp_e = Entry(master, width=25, font=('arial 18'))
        self.totalsp_e.place(x=450, y=370)

        self.vendor_e = Entry(master, width=25, font=('arial 18'))
        self.vendor_e.place(x=450, y=420)

        self.vendor_phone_e = Entry(master, width=25, font=('arial 18'))
        self.vendor_phone_e.place(x=450, y=470) 

        # button to add to the database
        self.btn_add = Button(master, text="Update", width=25, height=2, bg='lightgreen', fg='white', command=self.update)
        self.btn_add.place(x=600, y=520)
    ...
    def update(self, *args, **kwargs):
        ...
        conn.commit() 
        tkinter.messagebox.showinfo("Success", "Record Updated Succesfully.")
